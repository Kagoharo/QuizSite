...
from .views import CategoryListView, QuizDetailView, CategoryDetailView, CategoryCreateView, CategoryUpdateView, \
    QuizCreateView, QuizUpdateView, UserAnswerView
...
urlpatterns = [
    ...
    path('quizzes/quiz/try/', UserAnswerView.as_view(), name='user_answer')
]
